      ...
      <div className="container px-5 py-24 mx-auto flex mt-10">
        <div className="lg:w-1/3 md:w-1/2 bg-zinc-900 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
          ...
          <form>
            ...
            <button className="text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded text-lg">
              Submit
            </button>
          </form>
        </div>
